...
const Mascot: React.FC = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (state === "idle" && !isMessageVisible) {
        ...
        if (shouldAnimate) {
          const randomState: MascotState =
            Math.random() > 0.5 ? "thinking" : "happy";
  ...
  const handleMascotClick = () => {
    ...
    if (isMessageVisible) {
      ...
      setState("speaking");
      const randomMessage =
        MASCOT_MESSAGES.speaking[
          Math.floor(Math.random() * MASCOT_MESSAGES.speaking.length)
        ];
            ...
            <motion.path
              ...
              animate={
                state === "happy" || state === "excited"
                  ...
                  ? {
                      d: [
                        "M 34 38 Q 40 42 46 38",
                        "M 34 40 Q 40 44 46 40",
                        "M 34 38 Q 40 42 46 38",
                      ],
                    }
                  : { d: "M 34 38 Q 40 42 46 38" }
            ...
            <motion.path
              ...
              animate={
                state === "happy" || state === "excited"
                  ? {
                      d: [
                        "M 58 52 Q 68 45 65 58",
                        "M 58 52 Q 72 40 70 55",
                        "M 58 52 Q 68 45 65 58",
                      ],
                    }
                  : { d: "M 58 52 Q 68 45 65 58" }
              ...
              transition={{
                duration: 0.3,
                repeat: state === "happy" || state === "excited" ? Infinity : 0,
              }}
            />
            ...
            <AnimatePresence>
              {state === "excited" && (
                <>
                  ...
                  >
                    <path
                      d="M 20 20 L 22 18 L 24 20 L 22 22 Z"
                      fill="#FDE047"
                    />
                    <path
                      d="M 18 22 L 24 22"
                  ...
                  >
                    <path
                      d="M 60 18 L 62 16 L 64 18 L 62 20 Z"
                      fill="#FDE047"
                    />
                    <path
                      d="M 58 20 L 64 20"
                  ...
                  >
                    <path
                      d="M 65 35 L 67 33 L 69 35 L 67 37 Z"
                      fill="#FDE047"
                    />
                    <path
                      d="M 63 37 L 69 37"
