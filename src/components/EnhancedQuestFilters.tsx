...
interface EnhancedQuestFiltersProps {
  ...
  onSortChange: (
    sort: "name" | "difficulty" | "age" | "tasks" | "recent"
  ) => void;
  activeFilters: {
    category?: string | null;
    difficulty?: string | null;
...
const EnhancedQuestFilters: React.FC<EnhancedQuestFiltersProps> = ({
  ...
  // Enhanced categories with proper quest categories
  const categories = [
    "All",
    "Mind & Intelligence",
    "Academics & Knowledge",
  ...
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    searchTimeoutRef.current = setTimeout(() => {
      console.log(`🔍 QuestFilters: Triggering search for "${value}"`);
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <select
            ...
            className="px-4 py-2 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring focus:ring-purple-200 text-sm font-medium"
          >
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder={
              isSearching
                ? "Searching quests..."
                : "Search magical quests by name or description..."
            }
            value={searchTerm}
          ...
          <motion.button
            ...
            className={`flex items-center justify-center px-8 py-4 rounded-2xl font-semibold transition-all duration-300 min-w-[140px] ${
              hasActiveFilters
                ...
                : "bg-white border-2 border-purple-200 text-purple-600 hover:border-purple-300 hover:shadow-lg"
            }`}
      ...
      {hasActiveFilters && (
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <span className="text-sm text-purple-600 font-semibold flex items-center">
          ...
          {activeFilters.category && (
            <motion.span
              className="bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 px-4 py-2 rounded-full text-sm flex items-center font-medium"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
